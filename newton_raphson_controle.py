...
'''
EM TESTE - DESCOMENTE SE QUISER TESTAR O CASO IEEE 14
'''
...
DBAR = [
    [1, 2, 1.060, 0.0,   232.4, -16.9, -999, 999, None,   0.0,   0.0,   0.0, 1, None],
    [2, 1, 1.045, -4.9,   40.0,  42.4, -40.0, 50.0, None, 21.7,  12.7,  0.0, 1, None],
    [3, 1, 1.010, -12.0,   0.0,  23.4,   0.0, 40.0, None, 94.2,  19.0,  0.0, 1, None],
    [4, 0, 1.019, -10.0,   0.0,   0.0, -999, 999, None,  47.8,  -3.9,  0.0, 1, None],
    [5, 0, 1.020, -8.7,    0.0,   0.0, -999, 999, None,   7.6,   1.6,  0.0, 1, None],
    [6, 1, 1.070, -14.0,   0.0,  12.2,  -6.0, 24.0, None, 11.2,   7.5,  0.0, 1, None],
    [7, 0, 1.062, -13.0,   0.0,   0.0, -999, 999, None,   0.0,   0.0,  0.0, 1, None],
    [8, 1, 1.090, -13.0,   0.0,  17.4,  -6.0, 24.0, None,  0.0,   0.0,  0.0, 1, None],
    [9, 0, 1.056, -14.0,   0.0,   0.0, -999, 999, None,  29.5,  16.6, 19.0, 1, None],
    [10, 0, 1.051, -15.0,  0.0,   0.0, -999, 999, None,   9.0,   5.8,  0.0, 1, None],
    [11, 0, 1.057, -14.0,  0.0,   0.0, -999, 999, None,   3.5,   1.8,  0.0, 1, None],
    [12, 0, 1.055, -15.0,  0.0,   0.0, -999, 999, None,   6.1,   1.6,  0.0, 1, None],
    [13, 0, 1.050, -15.0,  0.0,   0.0, -999, 999, None,  13.5,   5.8,  0.0, 1, None],
    [14, 0, 1.036, -16.0,  0.0,   0.0, -999, 999, None,  14.9,   5.0,  0.0, 1, None]
]
...
controle_PV = True #True = ativado; Falso=desativado.
