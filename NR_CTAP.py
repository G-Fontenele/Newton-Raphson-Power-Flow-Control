...
DBAR = [
    ...
    [2, 1, 1.045, -5.0,   40.4,  44.8, -40.0, 50.0, None, 21.7,  12.7,  0.0, 1, None],
    [3, 1, 1.010, -13.0,   0.2,  5.67,   0.0, 40.0, None, 94.2,  19.0,  0.0, 1, None],
    [4, 0, 1.017, -10.0,   0.0,   0.0, -999, 999, None,  47.8,  -3.9,  0.0, 1, None],
    [5, 0, 1.020, -8.8,    0.0,   0.0, -999, 999, None,   7.6,   1.6,  0.0, 1, None],
    [6, 1, 1.070, -14.0,   0.1, 11.68,  -6.0, 24.0, None, 11.2,   7.5,  0.0, 1, None],
    [7, 0, 1.000, -13.0,   0.0,   0.0, -999, 999, None,   0.0,   0.0,  0.0, 1, None],
    [8, 1, 1.090, -13.0,   0.1,  6.68,  -6.0, 24.0, None,  0.0,   0.0,  0.0, 1, None],
...
DLIN = [
    ...
    [4, 9, 1, 0.0, 55.618, 0.0, 0.969, 0.8, 1.2, 0.0, 9, None, None, None],
